...
<body class="font-[Poppins] bg-gradient-to-t from-[#96EFFF] to-[#7B66FF] min-h-screen">
  ...
  <h1 class="text-3xl font-semibold m-6 text-black">Daftar Buku yang Dipinjam</h1>
  <div class="grid grid-cols-1 gap-4">
    <div class="flex items-center border p-4 bg-white mx-36 rounded-md">
      <div class="border border-gray-300 mr-4 flex-shrink-0 h-32 w-20 rounded-md overflow-hidden">
        <img src="<?php echo e(URL('img/vol-2.jpeg')); ?>" alt="Cover Buku" class="w-full h-full object-cover" />
      </div>
      <div>
        <h2 class="text-lg font-semibold mb-2">Judul Buku 1</h2>
        <p class="text-gray-700">Penulis 1</p>
        <p class="text-sm text-gray-600 mt-2">Status: Dipinjam</p>
      </div>
    </div>
    ...
    <!-- PKE 1 AJ ITU CMA TAMBAHANPKE LIAT TAMPILAN AJ NANTI DUPLICATE PKE CRUD -->
  </div>
...
<?php /**PATH D:\Kelompok web\book\resources\views/daftar_pinjaman.blade.php ENDPATH**/ ?>