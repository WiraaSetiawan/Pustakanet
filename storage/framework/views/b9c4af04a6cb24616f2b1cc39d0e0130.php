            ...
            <table class="min-w-full bg-white border border-gray-300 rounded-md">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b"><?php echo e($user->phone_number); ?></td>
                        <td class="py-2 px-4 border-b"><?php echo e($user->address); ?></td>
               ...
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td class="py-2 px-4 border-b">
                            <a href="<?php echo e(route('user.edit', ['id' => $user->id])); ?>" class="text-primary mr-2">Edit</a>
                            <form action="<?php echo e(route('user.delete',['id' => $user->id])); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Lenovo\Downloads\book\resources\views/user_show.blade.php ENDPATH**/ ?>