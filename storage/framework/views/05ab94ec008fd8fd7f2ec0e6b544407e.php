...
<body class="font-[Poppins] bg-gradient-to-t from-[#96EFFF] to-[#7B66FF] min-h-screen">
    ...
    <div class="m-36 flex justify-between items-center grid grid-cols-3 gap-y-28">
        ...
        <div class="flex w-80 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
            <div class="aspect-auto object-contain mx-4 -mt-6 h-[400px] overflow-hidden rounded-xl bg-cover bg-center" style="background-image: url('img/<?php echo e($book->sampul); ?>');">
            </div>
            <div class="p-6">
...
</html><?php /**PATH D:\Kelompok web\book\resources\views/book_list.blade.php ENDPATH**/ ?>