    ...
    <div class="flex items-center border p-4 bg-white mx-36 rounded-md mt-5">
        ...
        <div>
            ...
            <form action="<?php echo e(route('pengembalian', ['book' => $borrow->book->id])); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <button class="cursor-pointer group relative flex gap-1.5 px-8 py-4 bg-black bg-opacity-80 text-[#f1f1f1] rounded-3xl hover:bg-opacity-70 transition font-semibold shadow-md" type="submit">Pengembalian</button>
                </form>
        </div>
    </div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php else: ?>
    <p class="text-center text-gray-500">Data Peminjaman Kosong</p>
<?php endif; ?>
    <footer>
...
<?php /**PATH C:\booknew\book\resources\views//daftar_pinjaman.blade.php ENDPATH**/ ?>