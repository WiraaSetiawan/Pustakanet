...
<body class="font-[Poppins] bg-gradient-to-t from-[#96EFFF] to-[#7B66FF] min-h-screen">
    ...
    <div class="m-36 flex justify-between items-center grid grid-cols-3 gap-y-28">
        ...
        <div class="flex w-80 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
            <div class="aspect-auto object-contain mx-4 -mt-6 h-[400px] overflow-hidden rounded-xl bg-cover bg-center" style="background-image: url('img/<?php echo e($book->cover_img); ?>');">
            </div>
            <div class="p-6">
                ...
                <p class="block font-sans text-base font-light leading-relaxed text-inherit antialiased">
                    <?php echo e($book->publish_year); ?>

                </p>
            </div>
            <div class="p-6 pt-0">
                <a href="<?php echo e(route('detail_book.show', ['slug' => $book->slug])); ?>">
...
</html><?php /**PATH C:\Users\Lenovo\Downloads\book\resources\views/book_list.blade.php ENDPATH**/ ?>