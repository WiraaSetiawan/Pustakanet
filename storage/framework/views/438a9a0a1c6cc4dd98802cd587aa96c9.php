...
<body class="font-[Poppins] bg-gradient-to-t from-[#96EFFF] to-[#7B66FF]">
    ...
    <div class="relative group">
        <button class="bg-blue-500 text-white py-2 px-4 rounded-full focus:outline-none focus:shadow-outline">Menu</button>
        <ul class="absolute hidden text-gray-700 pt-1 group-hover:block">
            <li><a href="<?php echo e(url('/profile')); ?>" class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap">Profile</a></li>
            <li><a href="<?php echo e(url('/logout')); ?>" class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap">Logout</a></li>
        </ul>
    </div>
</div>
<?php else: ?>
<div class="flex items-center justify-center">
    <div class="relative group">
        <button class="bg-blue-500 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline"><a href="<?php echo e(url('/login')); ?>" class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap">Login</a></button>
        <ul class="absolute hidden text-gray-700 pt-1 group-hover:block">
            <li></li>
        </ul>
    </div>
    ...
    <div class="m-24 flex items-center">
        <div class="flex-1 pr-6">
            ...
            <ul id="typing-list" class="text-white text-4xl uppercase font-semibold tracking-wide mb-7">
                <li>tentang <span id="text"></span></li>
            </ul>
...
</html><?php /**PATH C:\Users\Lenovo\Downloads\book\resources\views/main.blade.php ENDPATH**/ ?>