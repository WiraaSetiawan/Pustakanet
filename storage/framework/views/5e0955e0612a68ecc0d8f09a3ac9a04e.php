...
<body class="font-[Poppins] bg-gradient-to-t from-[#96EFFF] to-[#7B66FF] min-h-screen">
    ...
    <main class="ml-64 p-6">
        <div>
        <form action="<?php echo e(route('categories.update', $category->slug)); ?>" method="post">
    <?php echo csrf_field(); ?>
    <?php echo method_field('PUT'); ?>
                <div class="mb-4">
                    <label for="name" class="text-light">Name</label>
                    <input type="text" name="name" id="name" value="<?php echo e($category->name); ?>"class="bg-gray-100 text-gray-900 border-0 rounded-md p-2 focus:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 transition ease-in-out duration-150" placeholder="Enter name">
                </div>
...
<?php /**PATH C:\Users\Lenovo\Downloads\book\resources\views/updateCategory.blade.php ENDPATH**/ ?>