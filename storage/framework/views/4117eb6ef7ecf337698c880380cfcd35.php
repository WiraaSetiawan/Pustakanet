...
<body class="font-[Poppins] bg-gradient-to-t from-[#96EFFF] to-[#7B66FF] min-h-screen">
  ...
  <main class="ml-64 p-6">
    ...
    <div class="my-5">
    <a href="/categories/create" class="bg-secondary text-dark px-3 py-1 rounded">add category</a>
...
<?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <tr>
        <td class="p-4 text-black text-center"><?php echo e($loop->iteration); ?></td>
        <td class="p-4 text-black text-center"><?php echo e($item->name); ?></td>
        <td class="p-4 text-black text-center">
          <div class="flex items-center justify-center">
            <a href="/categories/<?php echo e($item->slug); ?>/edit" class="text-black px-3 py-1 rounded">edit</a>

            <!-- Formulir DELETE di dalam loop -->
            <form action="<?php echo e(route('categories.destroy', ['id' => $item->id])); ?>" method="post">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Lenovo\Downloads\book\resources\views/category.blade.php ENDPATH**/ ?>