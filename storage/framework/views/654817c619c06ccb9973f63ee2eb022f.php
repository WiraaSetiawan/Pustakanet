...
<body class="font-[Poppins] bg-gradient-to-t from-[#96EFFF] to-[#7B66FF] min-h-screen">
    ...
    <div class="w-full max-w-md bg-white rounded-lg shadow-md p-6">
        ...
        <form class="flex flex-col" method="POST" action="<?php echo e(route('login')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <span class="text-red-500"><?php echo e($errors->first('error')); ?></span>
           <?php endif; ?>
...
</html><?php /**PATH C:\Users\Lenovo\Downloads\book\resources\views/login.blade.php ENDPATH**/ ?>