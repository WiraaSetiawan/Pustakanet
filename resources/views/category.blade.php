...
@forelse ($categories as $item)
    <tr>
        <td class="p-4 text-black text-center">{{ $loop->iteration }}</td>
        <td class="p-4 text-black text-center">{{ $item->name }}</td>
        <td class="p-4 text-black text-center">
          <div class="flex items-center justify-center">
            <a href="/categories/{{$item->slug}}/edit" class="text-black px-3 py-1 rounded">edit</a>
