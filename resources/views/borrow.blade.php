...
<body class="font-[Poppins] bg-gradient-to-t from-[#96EFFF] to-[#7B66FF] min-h-screen">
    ...
    <main class="ml-64 p-6">
      ...
      <tr>
        ...
        <td class="py-2 px-4 border-b">{{ $book->borrow->id }}</td>
        <td class="py-2 px-4 border-b">{{ $book->borrow->user->name }}</td>
        <td class="py-2 px-4 border-b">{{ $book->title }}</td>
        <td class="py-2 px-4 border-b">{{ $book->borrow->borrow_date }}</td>
        <td class="py-2 px-4 border-b">{{ $book->borrow->return_date }}</td>
      </tr>
            @endforeach
                </tbody>
            </table>
