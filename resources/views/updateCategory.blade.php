...
<body class="font-[Poppins] bg-gradient-to-t from-[#96EFFF] to-[#7B66FF] min-h-screen">
    ...
    @method('PUT')
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ $category->name }}"class="bg-gray-100 text-gray-900 border-0 rounded-md p-2 focus:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 transition ease-in-out duration-150" placeholder="Enter name">
                </div>
