...
<body class="font-[Poppins] bg-gradient-to-t from-[#96EFFF] to-[#7B66FF]">
    ...
    <div class="relative group">
        ...
        <ul class="absolute hidden text-gray-700 pt-1 group-hover:block">
            <li><a href="{{ url('/profile') }}" class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap">Profile</a></li>
            <li><a href="{{ url('/logout') }}" class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap">Logout</a></li>
        </ul>
    </div>
</div>
@else
<div class="flex items-center justify-center">
    <div class="relative group">
        <button class="bg-blue-500 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline"><a href="{{ url('/login') }}" class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap">Login</a></button>
        <ul class="absolute hidden text-gray-700 pt-1 group-hover:block">
            <li></li>
        </ul>
    </div>
...
@endif
    ...
    <div class="m-24 flex items-center">
        ...
        <div class="ml-auto">
            <img src="{{ URL('img/book.png') }}" class="w-[500px] h-[400px]">
        </div>
